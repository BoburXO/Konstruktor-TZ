    ...
    <div className={s.reg_parent}>
      <div className={s.reg_card}>
        ...
        <a
          target="_blank"
          onClick={() =>
            (window.location.href = `https://sso.egov.uz/sso/oauth/Authorization.do?response_type=one_code&client_id=single_reester&redirect_uri=z/oneid/one&state=test&scope=myportal`)
          }
        >
